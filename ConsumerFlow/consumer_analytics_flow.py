...
def consumer_analytics_flow_test(driver):
    ...
    try:
        ...
        screenshot_path = os.path.join(screenshot_dir, 'analytics_page.png')
        ...
        select.select_by_visible_text("Sivasagar")
        time.sleep(4)

        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'sivasagar_district.png')

        # Capture and save the screenshot
        driver.save_screenshot(screenshot_path)
        print("Sivasagar district selected")
    ...
    try:
        ...
        select = Select(select_element)
        select.select_by_visible_text("Sibsagar")
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'sivasagar_Sibsagar.png')

        # Capture and save the screenshot
        driver.save_screenshot(screenshot_path)
        print("Sibsagar district selected")
    ...
    try:
        ...
        time.sleep(2)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'show_calendar.png')

        # Capture and save the screenshot
        driver.save_screenshot(screenshot_path)
        driver.find_element(By.XPATH, "//button[@value='7']").click()
        print("July Month selected")
        time.sleep(4)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'sivasagar_Sibsagar_July_2024.png')
    ...
    try:
        ...
        time.sleep(2)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'hazard_show_options.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'hazard_monthly_rainfall.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'hazard_sum_inundation_ratio.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'hazard_mean_elevation.png')
    ...
    try:
        ...
        time.sleep(2)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'exposure_show_options.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'exposure_total_households.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'exposure_population.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'exposure_elderly_population.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'exposure_children_population.png')
    ...
    try:
        ...
        time.sleep(2)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_show_options.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_health_centre.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_domestic_electricity.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_piped_water.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_without_sanitation.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_number_schools.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_rail_length.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_road_length.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_sown_area.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_sex_ratio.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_population_affected.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_humans_life_lost.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_crop_area_affected.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_embankments_affected.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_roads_damaged.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_bridges_damaged.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'vulnerability_embankments_breached.png')
    ...
    try:
        ...
        time.sleep(2)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'govt_response_show_options.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'govt_response_flood_tenders.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'govt_response_flood_tenders_sdrf.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'govt_response_flood_tenders_repair_restore.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'govt_response_flood_tenders_immediate_measures.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'govt_response_flood_tenders_other.png')
    ...
    try:
        ...
        time.sleep(3)
        # Define the full path for the screenshot
        screenshot_path = os.path.join(screenshot_dir, 'govt_response_funds_allocated_sdrf_sec.png')
